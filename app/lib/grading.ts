...
export const ERROR_MESSAGE: Record<ErrorCode, string> = {
  ...
  "E-AUTH": "접근 권한이 없습니다. 데모 비밀번호를 확인해 주세요.",
...
export function normalizeBody(raw: unknown): string {
  ...
  //    <중략> 【생략】 [중략] (꺾쇠·대괄호) / …(중략)… (생략부호로 감싼 괄호형)
  //    생략부호는 … (U+2026) 뿐 아니라 ASCII 점 3개 이상(...)도 허용 — 실사용 빈도가 높다
  //    (EPO 2026-05-26 결정: §3.3 문자 표기를 dot-ellipsis까지 확장). 단 점은 양쪽을 모두 감쌀 때만.

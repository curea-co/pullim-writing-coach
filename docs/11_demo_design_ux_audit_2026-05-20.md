...
| U3 | **1문장 60자 권장** (F5) | ⚠️ | 일부 feedback_fix 2~3문장·100자 초과(데모는 06 v.4 데이터 상속) | **알려진 의제** — functional_spec §3 F5 룰 성격 확정(기준 B freeze 의제). 데모는 데이터 원본을 따름 |
...
**알려진 의제(데이터 원본):** U3 60자 룰 — 기준 B freeze 의제
